...
import type { Category as _Category, Order as _Order, Product as _Product, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addOrder(arg0: CartItem, arg1: string): Promise<Order> {
        if (this.processError) {
            try {
    ...
    async addProduct(arg0: string, arg1: string, arg2: number, arg3: Category, arg4: string, arg5: string | null, arg6: string, arg7: boolean, arg8: Array<bigint>): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, arg1, arg2, to_candid_Category_n8(this._uploadFile, this._downloadFile, arg3), arg4, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg5), arg6, arg7, arg8);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async checkout(arg0: string): Promise<Order | null> {
        if (this.processError) {
            try {
    ...
    async getFrequentlyBoughtTogether(arg0: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFrequentlyBoughtTogether(arg0);
    ...
    async getMegaBundleProduct(): Promise<Product | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMegaBundleProduct();
    ...
    async getOrderDownloadLinks(arg0: bigint): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOrderDownloadLinks(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        frequentlyBoughtTogether: value.frequentlyBoughtTogether,
        category: from_candid_Category_n15(_uploadFile, _downloadFile, value.category),
        isMegaBundle: value.isMegaBundle,
        price: value.price,
        videoPreviewUrl: record_opt_to_undefined(from_candid_opt_n17(_uploadFile, _downloadFile, value.videoPreviewUrl))
    };
}
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "viralReelsLibrary" in value ? Category.viralReelsLibrary : "editingSuite" in value ? Category.editingSuite : "masterclassCourses" in value ? Category.masterclassCourses : "softwareTools" in value ? Category.softwareTools : value;
}
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.viralReelsLibrary ? {
        viralReelsLibrary: null
    } : value == Category.editingSuite ? {
        editingSuite: null
    } : value == Category.masterclassCourses ? {
        masterclassCourses: null
    } : value == Category.softwareTools ? {
        softwareTools: null
    } : value;
}
